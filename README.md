...
> 这玩意需要我们分期来做  MVP 但是做出来的东西要能够复用  https://www.jianshu.com/p/1f91cfd68d48
...
##### 系统服务层（业务逻辑层） Presenter

1.搜索 用关键词找到商家  

2.首页信息 要么抓取，要么自己自动生成新闻（这就涉及到机器学习的技术了）
...
数据库选用：连接池绒里那个100左右 然后速度 100人左右的同时兼容查询

服务器解决方案：并发性能在100人左右同时浏览不卡顿 核估一下这个性能！

然后初期预计会员数在1000左右 每个人都有自己的数据量，然后想好收集什么。